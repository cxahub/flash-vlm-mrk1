...
const step = ref(1);
const question = ref("What is the business function of your role?");
...
function updateList(value) {
  ...
  nuxtStorage.localStorage.setData("businessfunction", this.bfSelected, 5);
  if (this.bfSelected === undefined || this.bfSelected.length == 0) {
    emit("disable", true);
  } else {
    emit("disable", false);
  }
