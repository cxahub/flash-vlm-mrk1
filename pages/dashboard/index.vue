<template>
  ...
  <div class="grid xl:grid-cols-2 gap-0 xl:gap-4">
    <div class="text-center xl:text-left xl:text-xl py-8">
      ...
      /></span>
      Click the "Start Assesssment Now" button to get started with your
      assessment. You can also choose from the many question topics below.<br /><br />
    ...
    <div class="py-10 text-center xl:text-right float-right">
      ...
      >
        Start Assesssment Now &rarr;</NuxtLink
      >
    </div>

    <div class="py-10 text-center xl:text-left">
      <UiButton
        :text="!showSurveyList ? 'Show My Assesssments' : 'Back to Dashboard'"
        path=""
